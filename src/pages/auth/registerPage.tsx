...
const RegisterSection= styled.section<{colors:Colors }>`
...
export default function RegisterPage() {
      ...
      if (typeof validate[0]==='string' || typeof validate[1]==='string') {
        setError({color:'#e24f4f',info:validate})
          ...
          if (typeof email==='string' && typeof password==='string') {
              const registering:alertMessageObject|void =await registerUser({email,password})  
    ...
    return (
        <Layout pageTitle='Register | Green Sports'>
         <RegisterSection colors={colorMode.themeColor} >
